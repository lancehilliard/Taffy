...
namespace Taffy.Sys {
    public class Files {
        public static void CreateTemporaryFiles(out string wavFileName, out string stretchedWavFileName, out string stretchedMp3FileName, out string sourceMp3TempFileName, out string concatenatedMp3TempFileName) {
            ...
            concatenatedMp3TempFileName = Path.GetTempFileName();
        }
